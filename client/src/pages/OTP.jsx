        ...
        <div className="flex flex-col justify-center md:flex-row h-screen">
            ...
            <div className="w-full md:w-1/2 flex items-center justify-center bg-white p-8 relative">
                ...
                <div className="max-w-sm w-full">
                    ...
                    <p className="text-grey-800 text-center mb-12">Please enter the OTP to Proceed.</p>
                    <form onSubmit={handleOtpVerification}>
                        ...
                        <button type="submit" className="border-2 mt-5 border-black w-full font-semibold bg-black text-white py-2 rounded-lg hover:bg-white hover:text-black transition mb-3 ">VERIFY</button>
                    </form>
                </div>
            </div>
