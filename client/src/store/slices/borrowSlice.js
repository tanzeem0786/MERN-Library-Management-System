...
export const fetchUserBorrowedBooks = () => async (dispatch) => {
    ...
    await axios.get("/api/v1/borrow/my-borrowed-books", { withCredentials: true })
        .then((res) => {
...
export const fetchAllBorrowedBooks = () => async (dispatch) => {
    ...
    await axios.get("/api/v1/borrow/borrowed-books-by-users", { withCredentials: true })
        .then((res) => {
...
export const recordBorrowBook = (email, id) => async (dispatch) => {
    ...
    await axios.post(`/api/v1/borrow/record-borrow-book/${id}`, { email }, {
...
export const returnBook = (email, id) => async (dispatch) => {
    ...
    await axios.put(`/api/v1/borrow/return-borrowed-book/${id}`, { email }, {
        withCredentials: true,
        headers: {
            "Content-Type": "application/json",
        }
